...
class plotting(object):
    ...
    def plot_calibration_curves(self, path='', data=None):
        ...
        ax.grid()
        plt.tight_layout()
        plt.savefig(os.path.join(path, 'calibration' + '.pdf'), dpi=200)
        plt.savefig(os.path.join(path, 'calibration' + '.png'), dpi=200)
        plt.close('all')
